...
import { Sprout, Upload, AlertCircle, CheckCircle2, PlusCircle, LayoutDashboard, Trash2, Calendar } from 'lucide-react';
...
export default function SellerPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Refresh listings and switch to view tab
      await fetchListings();
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-white shadow-md rounded-xl my-10 border border-green-100">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 pb-4 border-b border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Manage your posted crops and publish new fresh harvests.</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 bg-gray-100 p-1 rounded-lg">
          ...
          >
            <LayoutDashboard className="w-4 h-4" /> My Posts ({myListings.length})
          </button>
          <button
      ...
      {/* Tab 2: Publish New Harvest Form */}
      {activeTab === 'new' && (
        <div>
          {errorMsg && (
